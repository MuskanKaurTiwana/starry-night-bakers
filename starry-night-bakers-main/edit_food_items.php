...
<div class="col-xs-3">
  ...
  <div class="form-area" style="padding: 10px 10px 110px 10px; ">
    ...
    description='$description',images_path='$dimage',options='$doption' where F_ID='$F_ID'");
    }
    ...
    // $query1 = mysqli_query($conn, "SELECT * FROM food");
...
<div class="col-md-6">
 <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> Image: </label>
            <input type="text" class="form-control" id="dimage" name="dimage" value=<?php echo $row1['images_path'];  ?> placeholder="images/image-name.extension" required="">
          </div>


          <div class="form-group">
            <label for="username"><span class="text-danger" style="margin-right: 5px;">*</span> ENABLE/DISABLE </label>
            <input type="text" class="form-control" id="doption" name="doption" value=<?php echo $row1['options'];  ?> placeholder="ENABLE/DISABLE" required="">
          </div>

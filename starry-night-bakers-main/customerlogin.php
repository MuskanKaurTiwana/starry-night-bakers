...
<html>
  ...
  <head>
    <title> Guest Login | STARRY NIGHT BAKERS </title>
  ...
  <body>
    ...
    <div class="jumbotron" style="background: none; color: white;">
     <h1>Hi Guest,<br> Welcome to <span class="edit"> STARRY NIGHT BAKERS </span></h1>
    ...
    <div class="container">
      ...
      <div class="panel panel-primary">
        <div class="panel-heading"> Kindly LOGIN to continue </div>

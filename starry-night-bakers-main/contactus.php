...
<html>
  ...
  <head>
    <title> Contact | STARRY NIGHT BAKERS </title>
...
?>
    ...
    <div class="heading" style="color:white">
     <strong>Want to contact <span class="edit"> STARRY NIGHT BAKERS </span>?</strong>
     <br>
    ...
    <div class="col-md-5" style="float: none; margin: 0 auto;">
      <div class="form-area">
        ...
        <br style="clear: both">
          ...
          <div class="form-group">
           <textarea class="form-control" type="textarea" id="message" name="message" placeholder="Message" maxlength="140" rows="5"></textarea>
...
$query = "INSERT into contactt(Name,Email,Mobile,Subject,Message) VALUES('$Name','$Email_Id','$Mobile_No','$Subject','$Message')";

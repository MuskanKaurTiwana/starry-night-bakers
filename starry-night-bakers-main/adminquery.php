...
<div class="container">
    <div class="container">
      ...
      <a href="myrestaurant.php" class="list-group-item">My Restaurant</a>
    		...
    		<a href="adminquery.php" class="list-group-item active">Queries</a>
    	</div>
    </div>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <tbody>
    <tr>
      ...
      <td><a href="mailto:<?php echo $row["Email"];?>"  class="btn btn-success" style="width:100px; margin-bottom:3px; border: 1px solid black">Mail</a><a href="tel:<?php echo $row["Mobile"];?>"  class="btn btn-primary" style="width:100px; border: 1px solid black">Call</a></td>
    </tr>
  </tbody>
  <?php $no++; ?>
